 ...
 * duplicate_subject_name / duplicate_subject_code surfaces at the top of the dialog
 ...
 * for them (SubjectsPage gates on `canWrite(role, 'courses')`).
 */
...
export function SubjectFormDialog({
  ...
  useEffect(() => {
    if (open) {
      ...
      setComponent(subject?.component ?? '');
    }
  }, [open, subject]);
