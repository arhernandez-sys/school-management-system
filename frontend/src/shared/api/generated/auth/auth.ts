...
export type LoginApiV1AuthLoginPostMutationError = ErrorType<
...
export const getRefreshApiV1AuthRefreshPostMutationOptions = <
  TError = ErrorType<ErrorResponse | HTTPValidationError | ErrorResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type RefreshApiV1AuthRefreshPostMutationError = ErrorType<
  ErrorResponse | HTTPValidationError | ErrorResponse
>;
 ...
 * @summary Terminate the current session (idempotent, api-spec §2.3)
 */
export const useLogoutApiV1AuthLogoutPost = <TError = ErrorType<ErrorResponse>, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof logoutApiV1AuthLogoutPost>>,
      TError,
...
export const meApiV1AuthMeGet = (
  ...
  return customInstance<CurrentUser>({ url: `/auth/me`, method: 'GET', signal }, options);
};
...
>(options?: {
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof meApiV1AuthMeGet>>> = ({ signal }) =>
    meApiV1AuthMeGet(requestOptions, signal);
...
export const getChangeMyPasswordApiV1AuthMePasswordPatchMutationOptions = <
...
export type ChangeMyPasswordApiV1AuthMePasswordPatchMutationResult = NonNullable<
  Awaited<ReturnType<typeof changeMyPasswordApiV1AuthMePasswordPatch>>
>;
export type ChangeMyPasswordApiV1AuthMePasswordPatchMutationBody = BodyType<ChangePasswordRequest>;
export type ChangeMyPasswordApiV1AuthMePasswordPatchMutationError = ErrorType<
 ...
 * @summary Change your own password (api-spec §2.3, FR-AUTH-09)
 */
export const useChangeMyPasswordApiV1AuthMePasswordPatch = <
  TError = ErrorType<ErrorResponse | ErrorResponse>,
  TContext = unknown,
>(
  options?: {
...
export const getResetUserPasswordApiV1AuthUsersUserIdResetPasswordPostMutationOptions = <
  TError = ErrorType<ErrorResponse | ErrorResponse | ErrorResponse | HTTPValidationError>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type ResetUserPasswordApiV1AuthUsersUserIdResetPasswordPostMutationResult = NonNullable<
  Awaited<ReturnType<typeof resetUserPasswordApiV1AuthUsersUserIdResetPasswordPost>>
>;
export type ResetUserPasswordApiV1AuthUsersUserIdResetPasswordPostMutationBody =
  BodyType<ResetPasswordRequest>;
export type ResetUserPasswordApiV1AuthUsersUserIdResetPasswordPostMutationError = ErrorType<
  ErrorResponse | ErrorResponse | ErrorResponse | HTTPValidationError
>;

/**
 * @summary Admin-initiated password reset (api-spec §2.3, FR-SET-04)
 */
export const useResetUserPasswordApiV1AuthUsersUserIdResetPasswordPost = <
  TError = ErrorType<ErrorResponse | ErrorResponse | ErrorResponse | HTTPValidationError>,
  TContext = unknown,
>(
  options?: {
...
> => {
  const mutationOptions =
    getResetUserPasswordApiV1AuthUsersUserIdResetPasswordPostMutationOptions(options);
